      ...
      <button
        ...
        class="${
          this.variant === 'primary'
            ? `inline-block btn py-3 px-8 text-center bg-green-700 hover:bg-green-dark text-white 700 transition-all duration-200 my-7 font-semibold rounded-md cursor-pointer ${this.className}`
